...
//To add in multiple names in one step using the += operator we will need to have the names in a seperate array that contains the names. Shown below
...
// PROBLEM 2.3 : FITNESS COMMITMENTS
